...
--llama 1 is dead so hidden
-- cron 5mins llama complainer 2 is ->jsatGzKxtwKWY-9iAkcgkdGqSB6rje4Wq5crM9OFY6o


local json = require("json")

TARGET_WORLD_PID = "fRO3xwuW33u1aNSEaIXwGc6q9G0ORCRukajbVWI-_Ow"
...
function Register()
  ...
  Send({
    ...
    Data = json.encode({
      ...
      Position = { 6, 8},
      Metadata = {
        DisplayName = "Llama Complainer 1",
        SkinNumber = 5,
      },
    }),
  })
